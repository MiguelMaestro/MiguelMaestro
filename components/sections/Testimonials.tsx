      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto">
          <AnimatePresence initial={false} custom={direction} mode="wait">
            ...
            >
              {/* Testimonial Card */}
              <div className="relative p-8 md:p-12 rounded-3xl backdrop-blur-md bg-white/10 dark:bg-black/20 border border-white/20 shadow-2xl">
                {/* Quote Icon */}
          ...
          <button
            ...
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 md:-translate-x-12 w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-azure-500/20 hover:border-azure-500/50 transition-all duration-300 group"
          >
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 md:translate-x-12 w-12 h-12 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center hover:bg-azure-500/20 hover:border-azure-500/50 transition-all duration-300 group"
          >
