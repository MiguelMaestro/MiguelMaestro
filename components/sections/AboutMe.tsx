      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="about-card mb-8">
          <motion.div
            ...
            className="p-8 rounded-2xl backdrop-blur-md bg-white/10 dark:bg-black/20 border border-white/20 shadow-xl"
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div
            ...
            onMouseLeave={handleMouseLeave}
          >
            <div className="p-6 rounded-2xl backdrop-blur-md bg-white/10 dark:bg-black/20 border border-white/20 shadow-xl h-full">
